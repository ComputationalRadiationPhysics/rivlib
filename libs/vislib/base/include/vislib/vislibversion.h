 ...
 */
#define VISLIB_BASE_REVISION        0
#define VISLIB_CLUSTER_REVISION     0
#define VISLIB_CLUSTERD3D_REVISION  0
#define VISLIB_CLUSTERGL_REVISION   0
#define VISLIB_D3D_REVISION         0
#define VISLIB_GL_REVISION          0
#define VISLIB_GRAPHICS_REVISION    0
#define VISLIB_MATH_REVISION        0
